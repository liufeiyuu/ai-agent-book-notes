...
- [真实模型退款咨询 Agent（TypeScript）](./refund-agent-real/README.md)：第二周补充实战，固定 RAG 与 Agent 两种入口；含分步带学指南。Qwen + DeepSeek V4 最终真实验收均 6/6，30 个离线测试通过；Agent 包含一次有界格式恢复。实现已验收，待带学理解。
